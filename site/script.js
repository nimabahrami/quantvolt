...
function openSearch(){dialog.showModal();searchInput.value='';renderSearch();setTimeout(()=>searchInput.focus(),0)}
document.querySelector('#search-trigger').addEventListener('click',openSearch);searchInput.addEventListener('input',renderSearch);searchResults.addEventListener('click',()=>dialog.close());
