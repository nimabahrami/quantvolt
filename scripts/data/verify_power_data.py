...
def main() -> None:
    ...
    fundamentals = pl.read_parquet(local_or_fetch(FUNDAMENTALS_DATA, "smard-de-power-fundamentals"))
    experiment = pl.read_parquet(local_or_fetch(EXPERIMENT_DATA, "smard-de-power-experiment"))
